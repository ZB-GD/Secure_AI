...
──────────────────
  ...
  ├── Desktop/Lab1/            ← archivos visibles en el escritorio
  │   ├── vulnerable_app.py    ← objetivo local vulnerable en 127.0.0.1:5000
  │   ├── poison_data.py       ← Paso 2: script de ataque
  │   └── validate_defense.py  ← Pasos 3-4-5: implementa tus defensas aquí
  ├── scripts/
  │   ├── vulnerable_app.py    ← enlace al archivo del Desktop
  │   ├── poison_data.py       ← enlace al archivo del Desktop
  │   └── validate_defense.py  ← enlace al archivo del Desktop
...
───────────
  ...
  El objetivo vulnerable corre localmente en:
      http://127.0.0.1:5000
