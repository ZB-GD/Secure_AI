export const journey = [
...

  {
    ...
    story: {
      ...
      mission:
        "Your task: inspect NODE-1 and NODE-2, then identify the first value that should have been rejected before preprocessing.",
    },
    evidence: { inputs: [], files: [], prompts: [], logs: [] },
    question: {
      text: "Looking closely at the logs for NODE-1 (Sensor Data Node) and NODE-2 (Edge Pre-processing Node), what specific anomalous value proves the dataset was poisoned?",
