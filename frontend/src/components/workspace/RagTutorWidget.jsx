...
export default function RagTutorWidget({
  phase,
  activeItem,
  placement = "floating",
}) {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      type: "text",
      content:
        "Hello! I am the CityFlow AI Tutor. I'm here to help you understand the investigation. Do you have any questions about the lab?",
    },
  ]);
  ...
  const handleQuizAnswer = (
    ...
    setMessages((prev) => [
      ...prev,
      {
        role: "user",
        type: "text",
        content: `He seleccionado la opción ${String.fromCharCode(65 + selectedOptionIndex)}`,
      },
      {
        role: "assistant",
        type: "text",
        content: isCorrect
          ? `Correcto. ${feedbackExp}`
          : `Incorrecto. ${feedbackExp}`,
        isHighlight: isCorrect,
      },
    ]);
  };
        ...
        style={{
          ...
          boxShadow: isTopbar
            ...
            : isOpen
              ...
              : "none",
          transition:
            "transform 0.18s ease, border-color 0.15s ease, background 0.15s ease, box-shadow 0.15s ease",
        }}
        onMouseOver={(e) =>
      ...
      >
        {isTopbar ? (
          <>
            ...
            <span>{isOpen ? "TUTOR" : "ASK TUTOR"}</span>
            <span
              style={{
                width: "7px",
                height: "7px",
